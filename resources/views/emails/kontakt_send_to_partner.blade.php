...
<!-- Notification 1  -->
<div style="display: none" id="element_011398555154138146"></div>
</p></div><!-- End Notification 1 -->

<!-- Notification 2  -->
<div style="display: none" id="element_028984366117975724"></div>
</p></div><!-- End Notification 2 -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#303030"
    ...
    <tr>
        <td align="center"
            style="background-image: url('http://rocketway.net/themebuilder/template/templates/notify/images/not3_bg_image.jpg'); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat; background-color: #303030;"
            id="not3">
                ...
                <tr>
                    <td width="100%" align="center">
                        ...
                        <div class="sortable_inner ui-sortable">
                            ...
                            <!-- Space -->
                            <table width="552" border="0" cellpadding="0" cellspacing="0" align="center" class="full"
                                   object="drag-module-small">
                                <tr>
                        ...
                        <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile"
                            ...
                            <tr>
                                <td width="352" valign="middle" align="center">
                                                ...
                                                <table width="265" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td valign="middle" width="100%"
                                                            style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 43px; color: #3f4345; line-height: 48px;"
                                                            class="fullCenter" cu-identify="element_032124659240732456">
                                                            <!--[if !mso]><!--><span
                                                                    style="font-family: 'proxima_novasemibold', Helvetica; font-weight: normal;"><!--<![endif]-->Vielen Dank für ihre Anfrage!
                                                                <!--[if !mso]><!--></span><!--<![endif]--></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <div style="display: none" id="element_043677716930047894"></div>
                                    </p></div>

                                    <div style="display: none" id="element_021053519141610444"></div>
                                    </p></div>
                                        ...
                                        <tr>
                                            <td width="352" valign="middle" align="center">
                                                ...
                                                <table width="265" border="0" cellpadding="0" cellspacing="0"
                                                       align="center" class="mobile">
                                                    <tr>
                                                        <td width="265" bgcolor="#fdba30" class="pad15" align="center"
                                                            style="background-color: rgb(255, 255, 255);">
                                                            ...
                                                            <table width="240" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" align="center" width="100%"
                                                                        style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #3f4345; line-height: 24px;"
                                                                        class="fullCenter"
                                                                        cu-identify="element_018856055554603557"></div>
                                                                        ...
                                                                        <p>Bis dorthin sind wir für Sie gerne
                                                                            ...
                                                                            oder per Email&nbsp;<strong>inform@inform-crailsheim.de&nbsp;</strong>erreichbar.<br><br>Gerne begrüßen wir Sie&nbsp;persönlich
                                                                            in unserem Fitness Studio in der <strong>Wittauer Str. 1<br>74564 Crailsheim</strong><br>Unsere Öffnungszeiten: Mo. - Do: 7.00 Uhr bis 23.00 Uhr,
                                                                            Fr: 9.00 Uhr bis 23.00 Uhr,
                                                                            Sa + So: 10.00 Uhr bis 17.00 Uhr
                                                                            Feiertag: 10.00 Uhr bis 14.00 Uhr
                                                                            <br></p></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <tr>
                                            <td width="352" valign="middle" align="center">
                                                ...
                                                <table width="265" border="0" cellpadding="0" cellspacing="0"
                                                       align="center" class="mobile">
                                                    <tr>
                                                        <td width="265" align="center" bgcolor="#fdba30" class="pad15"
                                                            style="background-color: rgb(255, 255, 255);">
                                                                        ...
                                                                        <table width="100%" border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" height="40"
                                                                                    bgcolor="#f0f0f0"
                                                                                    style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 22px; padding-right: 22px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); background-color: rgb(63, 81, 181);">
                                                                                    <!--[if !mso]><!--><span
                                                                                            style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->
																						<a href="http://www.inform-crailsheim.de/"
                                                                                           style="color: rgb(255, 255, 255); font-size: 16px; text-decoration: none; line-height: 34px; width: 100%;"
                                                                                           cu-identify="element_019302723327086047">Unsere Website</a>
                                                                                        <!--[if !mso]><!--></span>
                                                                                    <!--<![endif]-->
                                                                                </td>
                                                                            </tr>
                                    ...
                                    <div style="display: none" id="element_07824443413089717"></div>
                                    </p></div>
                                    ...
                                    <div style="display: none" id="element_0746703837140435"></div>
                                    </p></div>

                                    <div style="display: none" id="element_08139821737308759"></div>
                                    </p></div>

                                    <div style="display: none" id="element_07518192640443502"></div>
                                    </p></div><!-- End Top -->
                                    </div>
                        ...
                        <div class="sortable_inner ui-sortable">
                            ...
                            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile"
                                   object="drag-module-small"
                                   style="position: relative; z-index: 0; left: 0px; top: 0px;">
                                <tr>
                                    <td width="352" valign="middle" align="center">
                                        ...
                                        <table width="352" border="0" cellpadding="0" cellspacing="0" align="center"
                                            ...
                                            <tr>
                                                <td width="352"
                                                    style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #3f4345; line-height: 24px;"
                                                    class="fullCenter"><!--[if !mso]><!--><span
                                                            style="font-family: 'proxima_nova_rgregular', Helvetica;"><!--<![endif]-->
                                                        <!--subscribe--><a href="https://www.inform-crailsheim.de/"
                                                                           style="text-decoration: none; color: #3f4345;"
                                                                           cu-identify="element_0613987915555534">©2001-2018 All Rights Reserved. InForm Crailsheim</a>
                                                        <!--unsub--><!--[if !mso]><!--></span><!--<![endif]-->
                                                    <span cu-identify="element_03174528261606192"></span>
                                                </td>
                                            </tr>
                                        </table>
...
<!-- Notification 4  -->
<div style="display: none" id="element_0056202559417471765"></div>
</p></div><!-- End Notification 4 -->

<!-- Notification 5 -->
<div style="display: none" id="element_07197561247987201"></div>
</p></div><!-- End Notification 5 -->

<!-- Notification 6 -->
<div style="display: none" id="element_08450712140095614"></div>
</p></div><!-- End Notification 6 -->
</div>
</body>
</html>
<style>body {
