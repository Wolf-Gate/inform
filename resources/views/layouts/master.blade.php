...
<nav class="panel top forceMobileView">
    ...
    <div class="sections compact hidden">
        <div class="left"></div>
        <div class="right"><span class="button actionButton white rounded sidebarTrigger" data-sidebar-id="1"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#menu"></use></svg></span></div>
    </div>
</nav>
<!-- Sidebar -->
